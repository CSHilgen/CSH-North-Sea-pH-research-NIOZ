...
sns.regplot(x='datenum', y='pH_total_spectro_out', data=RWSnmean, ax=ax, x_estimator=np.mean,
            scatter_kws={"color": "None"}, line_kws={"color": "grey", 'linestyle': 'dashdot', 'label': f'y = {dslope:.1e}x + {dintercept:.1f}'}, x_ci="sd")
ax.scatter('datenum', 'pH_total', data=RWSomean, c='xkcd:water blue', label='RWS')
ax.scatter('datenum', 'pH_totalspectro_out', data=RWSnmean, c='xkcd:cobalt blue', label='RWS')
