...
RWSomeanlr = RWSomean.dropna(axis='rows', how='all', subset=['total_phosphate'])
slope, intercept, r, p, se = linregress(RWSomeanlr['datenum'], RWSomeanlr['total_phosphate'])
...
RWSomean['sc_Phosphate'] = SF_tools.seasonalcycle_fit(opt_result['x'], RWSomean['datenum']) # sc = seasoncal cycle
slope, intercept, sine_stretch, sine_shift = opt_result['x']
RWSomean['ms_Phosphate'] = RWSomean['total_phosphate'] - RWSomean['sc_Phosphate'] # ms = minus seasonality
...
sns.regplot(x='datenum', y='total_phosphate', data=RWSomean, ax=ax, ci=99.9,
            scatter_kws={"color": "xkcd:navy"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.1f}'}, label='Initial PO$_4^{-3}$ RWS')
...
slope, intercept, r, p, se = linregress(RWSomean['datenum'], RWSomean['sc_Phosphate'])
...
ax = axs[1]
RWSomean.plot.scatter("datenum", "total_phosphate", ax=ax, c='xkcd:navy', label='Initial PO$_4^{-3}$ RWS')
...
slope, intercept, r, p, se = linregress(RWSomean['datenum'], RWSomean['ms_Phosphate'])
...
ax = axs[2]
sns.regplot(x='datenum', y='ms_Phosphate', data=RWSomean, ax=ax, ci=99.9,
            scatter_kws={"color": "xkcd:navy"}, line_kws={"color": "blue", 'label': f'y = {slope:.1f}x + {intercept:.1e}'}, label='Seasonal corrected PO$_4^{-3}$ RWS')
...
plt.tight_layout()
plt.savefig("figures/Long_Term_Trends/Phosphate_season_fitting_RWSomean.png")    
plt.show()
...
slope, intercept, r, p, se = linregress(RWSomean[L0]['datenum'], RWSomean[L0]['total_phosphate'])

ax = axs[0]
sns.regplot(x='datenum', y='total_phosphate', data=RWSomean[L0], ax=ax,
            scatter_kws={"color": "xkcd:navy"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.2f}'}, label='Initial PO$_4^{-3}$ RWS')
...
slope, intercept, r, p, se = linregress(RWSomean[L1]['datenum'], RWSomean[L1]['total_phosphate'])

ax = axs[1]
sns.regplot(x='datenum', y='total_phosphate', data=RWSomean[L1], ax=ax,
            scatter_kws={"color": "xkcd:navy"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.2f}'}, label='Initial PO$_4^{-3}$ RWS')
...
slope, intercept, r, p, se = linregress(RWSomean[L2]['datenum'], RWSomean[L2]['total_phosphate'])

ax = axs[2]
sns.regplot(x='datenum', y='total_phosphate', data=RWSomean[L2], ax=ax,
            scatter_kws={"color": "xkcd:navy"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.2f}'}, label='Initial PO$_4^{-3}$ RWS')
...
plt.tight_layout()
plt.savefig("figures/Long_Term_Trends/Phosphate_split_up_RWSomean.png")     
plt.show()
