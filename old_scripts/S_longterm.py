...
sns.regplot(x='salinity', y='alkalinity', data=combinedmean, ax=ax,
            scatter_kws={"color": "None"}, line_kws={"color": "blue", 'label': 'y = -27.5x + 3270.3'})

sc = ax.scatter('salinity', 'alkalinity', c='dayofyear', cmap='twilight', data=combinedmean, marker='v', label='TA', vmin=vmin, vmax=vmax)
#ax.plot('salinity', 'predicted_alkalinity', c='blue', data=combinedmean, label='predicted TA')
...
plt.tight_layout()
plt.savefig("figures/S_longterm/TApredicted_S_mean_scatter2.png")
plt.show()
...
opt_result = least_squares(lsq_fco2_fit, [0.00582, 299.066, -88.57, 741], 
...
plt.tight_layout()
plt.savefig("figures/S_longterm/pH_mean_time_datasets_RWSo&RWSnspectro&RWSopred3_zoomin2.png")
plt.show()
