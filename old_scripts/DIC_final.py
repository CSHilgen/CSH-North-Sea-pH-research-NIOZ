...
combinedmeanlr = combinedmean.dropna(axis='rows', how='all', subset=['dic'])
slope, intercept, r, p, se = linregress(combinedmeanlr['datenum'], combinedmeanlr['dic'])
...
print('Long term trend of DIC combinedmean')

# L = combinedmean.year > 2000
# combinedmean = combinedmean[L]
combinedmean = combinedmean.dropna(axis='rows', how='all', subset=['normalized_DIC'])
...
sns.regplot(x='datenum', y='normalized_DIC', data=combinedmean, ax=ax, ci=99.9,
            scatter_kws={"color": "xkcd:purple"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.2f}'}, label='Initial DIC Combined')
...
slope, intercept, r, p, se = linregress(combinedmeansc_dic['datenum'], combinedmeansc_dic['sc_dic'])
...
slope, intercept, r, p, se = linregress(combinedmean['datenum'], combinedmean['ms_dic'])
...
sns.regplot(x='datenum', y='ms_dic', data=combinedmean, ax=ax, ci=99.9,
             scatter_kws={"color": "purple"}, line_kws={"color": "blue", 'label': f'y = {slope:.1f}x + {intercept:.1e}'}, label='Seasonal corrected DIC Combined')
...
# L = combinedmean.year > 2000
# combinedmean = combinedmean[L]
combinedmean = combinedmean.dropna(axis='rows', how='all', subset=['dic_correctd_final'])
...
slope, intercept, r, p, se = linregress(combinedmean[L0]['datenum'], combinedmean[L0]['normalized_DIC'])

ax = axs[0]
sns.regplot(x='datenum', y='normalized_DIC', data=combinedmean[L0], ax=ax,
            scatter_kws={"color": "xkcd:purple"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.2f}'}, label='Normalized DIC Combined')
...
slope, intercept, r, p, se = linregress(combinedmean[L1]['datenum'], combinedmean[L1]['normalized_DIC'])

ax = axs[1]
sns.regplot(x='datenum', y='normalized_DIC', data=combinedmean[L1], ax=ax,
            scatter_kws={"color": "xkcd:purple"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.2f}'}, label='Normalized DIC Combined')
