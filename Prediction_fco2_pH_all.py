...
plt.tight_layout()
plt.savefig("figures/Final_plots/fCO2_prediction_TA_DICair.png") 
...
ax = ax
sns.regplot(x='datenum', y='pH_total', data=RWSomean, ax=ax, x_estimator=np.mean,
            scatter_kws={"color": "None"}, line_kws={"color": "blue", 'label': f'y = {slope:.1e}x + {intercept:.1f}'})
sns.regplot(x='datenum', y='pH_total_spectro_out', data=RWSnmean, ax=ax, x_estimator=np.mean,
...
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanN[LRg], edgecolors='xkcd:light violet', facecolors='None', label='GLODAP$_{pred}$', s=50,linewidth=2)
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanN[LRd], edgecolors='xkcd:neon pink', facecolors='None', label='D366$_{pred}$', s=50,linewidth=2)
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanN[LRc], edgecolors='xkcd:orange', facecolors='None', label='CEFAS$_{pred}$', s=50, linewidth=2)
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanN[LRr], edgecolors='xkcd:evergreen', facecolors='None', label='RWS$_{pred}$', s=50, linewidth=2)
...
sns.regplot(x='datenum', y='pH_total', data=RWSomeanpH[L2][L0], ax=ax, x_estimator=np.mean,
            scatter_kws={"color": "None"}, line_kws={"color": "blue", 'label': f'y = {dslope:.1e}x + {dintercept:.1f}', 'linestyle': 'dotted'})
sns.regplot(x='datenum', y='pH_total_spectro_out', data=RWSnmeanpH, ax=ax, x_estimator=np.mean,
            scatter_kws={"color": "None"}, line_kws={"color": "xkcd:cobalt blue", 'label': f'y = {aslope:.1e}x + {aintercept:.1f}'})
ax.scatter('datenum', 'pH_total', data=RWSomean, c='xkcd:water blue', label='RWS')
ax.scatter('datenum', 'pH_total_spectro_out', data=RWSnmean, c='xkcd:cobalt blue', label='RWS$_{spectro}$')
...
ax = ax
sns.regplot(x='datenum', y='fco2_sea', data=socatnsmean, ax=ax, x_estimator=np.mean,
            scatter_kws={"color": "xkcd:goldenrod"}, line_kws={"color": "xkcd:goldenrod", 'label': f'y = {slope:.1e}x + {intercept:.1f}'}, label='SOCAT$_{SW}$')
# sns.regplot(x='datenum', y='fCO2', data=socatnsmean, ax=ax, ci=99.9,
#             scatter_kws={"color": "xkcd:black"}, line_kws={"color": "xkcd:dark grey", 'label': f'y = {bslope:.1e}x + {bintercept:.1f}'}, label='SOCAT$_{AIR}$')
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanNC[LRg], edgecolors='xkcd:light violet', facecolors='None', label='GLODAP$_{pred}$', s=50,linewidth=2)
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanNC[LRd], edgecolors='xkcd:neon pink', facecolors='None', label='D366$_{pred}$', s=50,linewidth=2)
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanNC[LRc], edgecolors='xkcd:orange', facecolors='None', label='CEFAS$_{pred}$', s=50, linewidth=2)
ax.scatter('datenum', 'fCO2', data=resultscombinedmeanNC[LRr], edgecolors='xkcd:evergreen', facecolors='None', label='RWS$_{pred}$', s=50, linewidth=2)
