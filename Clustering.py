...
# x = RWSnmean[fvar].to_numpy()
# y = RWSnmean.dic.to_numpy()
...
plt.savefig("figures/DIC_TA_fitting/DIC_RWSn_Clustering3.png")    
...
combinedmeandic2['dicminusseason'] = (combinedmeandic2['dic'] - combinedmeandic2['interpolator_dic'])
