...
HM16_plots.get_T_DIC_TA_curves(allparametersdubbel, allparameters, timeperiod)
...
# Function to get plot of pH predicted and pH fitted
HM16_plots.get_pHpred_pHfit_2018_2021(allparametersdubbel, resultsRWSndubbel, allparameters, resultsRWSn, timeperiod)
